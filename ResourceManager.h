...
public:
	...
	*/
	...
	void ReleaseSoundName(const char* file);

	void removeSounds(const char* file);
...
private:
	...
	*/
	...
	std::vector<Mix_Chunk*>	mSoundsVector;
	...
	std::map<std::string, Sint32>	mIDsound;
	Uint32				mFirstFreeSlot;		/*!<  First free slot in the mGraphicsVector*/
	Uint32				mFirstFreeSlotSound;
